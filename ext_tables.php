...
ExtensionUtility::registerPlugin(
    ...
    ExtensionUtility::registerModule(
        ...
        ['access' => 'user,group', 'icon' => 'EXT:pongback/ext_icon.gif', 'labels' => 'LLL:EXT:pongback/Resources/Private/Language/locallang_pongbackbackend.xlf']
    );


ExtensionManagementUtility::addStaticFile('pongback', 'Configuration/TypoScript', 'Pongback');

ExtensionManagementUtility::addLLrefForTCAdescr('tx_pongback_domain_model_pingback',
